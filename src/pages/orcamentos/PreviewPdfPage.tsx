...
function DocumentoPDF({ orcamento, sinal, empresa }: { orcamento: OrcamentoDetalheResponse | null; sinal: boolean; empresa: EmpresaResponse | null }) {
  ...
  return (
    <div className="flex min-h-[calc((820px-72px)*1.414)] w-full flex-col rounded-[4px] border border-line bg-white p-14 shadow-[0_10px_40px_-8px_rgba(31,38,52,0.18),0_2px_8px_rgba(0,0,0,0.06)] max-[767px]:min-h-0 max-[767px]:px-6 max-[767px]:py-8">
